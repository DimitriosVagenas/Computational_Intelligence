...
public class PerceptronTwoLevels {
	...
	private static double n = 0.000002; // Learning step
	private static int B = 1; // B = 1 for serial update, B = N for group update
	private static int h1 = 30; // Number of neurons at hidden level H1
	private static int h2 = 30; // Number of neurons at hidden level H2
	private static double katwfli = 0.1; // Error threshold
	private static boolean pickRelu = true; // True for ReLU False for tanh




	private static String data = "";
	private static int tes = 4000; // Number of points
	private static String[] arrOfStr= new String[tes];
	private static Point[] points = new Point[tes];
	private static double[][] newInputs; //Inputs
	private static double[][] newInputs1; //Outputs of level H1
	private static double[][] newInputs2; //Outputs of level H2
	private static double[][] newInputs3; //Outputs
	private static double[][] newOutputs;
	private static int ClusterNumber = 4; // Number of teams
	private static double[][] weight1; // Weights between Input-H1
	private static double[][] weight2; // Weights between H1-H2
	private static double[][] weight3; // Weights between H2-Output
	private static double[][] errorOl1 = new double[2+1][h1]; // dE/dw for weight1
	private static double[][] errorOl2 = new double[h1+1][h2]; // dE/dw for weight2
	private static double[][] errorOl3 = new double[h2+1][ClusterNumber]; // dE/dw for weight3
	private static double[][] deltaExodus = new double[tes][ClusterNumber]; // delta at Output
	private static double[][] deltaProExodus = new double[tes][h2]; // delta at H2
	private static double[][] deltaProProExodus = new double[tes][h1]; // delta at H1
